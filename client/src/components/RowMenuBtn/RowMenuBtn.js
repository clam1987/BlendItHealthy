    ...
    let handleClick = (e) => {
        ...
        switch (val) {
            case "red":
                ...
                return setClickedRed({ dataColor: val, isClicked: true, pageStyle: { backgroundColor:"#E55538", fontSize:24 } }),menuImg.src = redMenu;
            case "green":
                setClickedRed(initialRedState);
                setClickedBlue(initialBlueState);
                setClickedPurple(initialPurpleState);
                setClickedYellow(initialYellowState);
                return setClickedGreen({ dataColor: val, isClicked: true, pageStyle: { backgroundColor:"#11AC4C", fontSize:26 } }),menuImg.src = greenMenu;
            case "blue":
                setClickedRed(initialRedState);
                setClickedGreen(initialGreenState);
                setClickedPurple(initialPurpleState);
                setClickedYellow(initialYellowState);
                return setClickedBlue({ dataColor: val, isClicked: true, pageStyle: { backgroundColor:"#0093D0", fontSize:20 } }),menuImg.src = blueMenu;
            case "purple":
                setClickedRed(initialRedState);
                setClickedGreen(initialGreenState);
                setClickedBlue(initialBlueState);
                setClickedYellow(initialYellowState);
                return setClickedPurple({ dataColor: val, isClicked: true, pageStyle: { backgroundColor:"#D0336A", fontSize:26 } }),menuImg.src = purpleMenu;
            case "yellow":
                setClickedRed(initialRedState);
                setClickedGreen(initialGreenState);
                setClickedBlue(initialBlueState);
                setClickedPurple(initialPurpleState);
                return setClickedYellow({ dataColor: val, isClicked: true, pageStyle: { backgroundColor:"#FEB600", fontSize:32 } }),menuImg.src = BYO;
            default:
                return
        }
    };
