    ...
    return (
        <div className="container-fluid">
                ...
                <div className="col-sm" id="botImgDiv">
                    ...
                    <p className="aboutBotText">So in 2014, <img src={pic} alt="" id="botImg" /> was born. Since then, we have cultivated a community of passionate individuals - encouraging them on their health journeys as they embrace food as a preventive medicine.</p>
                </div>
            </div>
        </div>
    )
